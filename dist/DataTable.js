...
var DataTable = function (_React$Component) {
  ...
  function DataTable(props) {
    ...
    _this.navClicked = props.navClicked;
  ...
  _createClass(DataTable, [{
    ...
    key: 'sort',
    value: function sort(name, isSorted) {
      if (!isSorted) return;
      ...
      columnStates = _lodash2.default.forIn(columnStates, function (columnState) {
      ...
      var sortComparator = this.createComparator(name, type);
      var data = _lodash2.default.cloneDeep(this.state.dataOri);
    ...
    value: function createComparator(field, type) {
      var sortComparatorAsc = function sortComparatorAsc(x, y) {
        if (x[field] < y[field]) return -1;
        if (x[field] > y[field]) return 1;
        return 0;
      };

      var sortComparatorDesc = function sortComparatorDesc(x, y) {
        if (x[field] > y[field]) return -1;
        if (x[field] < y[field]) return 1;
        return 0;
      };

      var sortComparator = type == 'asc' ? sortComparatorAsc : sortComparatorDesc;
    ...
    value: function render() {
      ...
      var rowProps = this.props.row;

      var fieldId = this.props.fieldId;
      var columns = this.state.columns;
      var data = this.state.data;
      var isPaging = this.state.isPaging;
      var columnStates = this.state.columnStates;
      var columnFrozenSize = 0;
      _lodash2.default.forEach(columns, function (column) {
      ...
      if (this.props.width !== '100%' && this.props.columnWidthType != '%') {
        tableWidth = columns.map(function (col) {
          return col.width;
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'data-table-scroller', style: wrapperStyle },
          _react2.default.createElement(
            'table',
            { className: 'data-table ui celled table', style: tableStyle },
            _react2.default.createElement(
              'thead',
              null,
              _react2.default.createElement(
                'tr',
                { className: 'data-table-row row-header', style: { height: rowProps.height } },
                columns.map(function (column, i) {

                  var thClasses = (0, _classnames2.default)({
                    'data-table-cell': true,
                    'frozen': column.isFrozen
                  });

                  var thStyles = {
                    'width': column.width + _this2.props.columnWidthType,
                    'textAlign': column.headerAlign,
                    'left': leftSize
                  };

                  var iconStyle = (0, _classnames2.default)({
                    'fa': true,
                  ...
                  return _react2.default.createElement(
                    'th',
                    { key: i, className: thClasses, style: thStyles, onClick: function onClick() {
                        return _this2.sort(column.name, column.isSorted);
                      } },
                    column.label,
                    ' ',
                    _react2.default.createElement('i', { className: iconStyle, 'aria-hidden': 'true' })
                  );
                })
              )
            ),
            _react2.default.createElement(
              ...
              data.map(function (row, i) {
                ...
                var tds = columns.map(function (column, j) {
                  var value = row[column.accessor];

                  var tdClasses = (0, _classnames2.default)({
                    'data-table-cell': true,
                    'frozen': column.isFrozen
                  });
                  ...
                  if (column.cell != null) {
                    var id = row[fieldId];
                    var content = column.cell(value, id);
                    return _react2.default.createElement(
                      'td',
                      { key: j, align: column.align, className: tdClasses, style: tdStyles },
                      content
                    );
                  } else {
                    return _react2.default.createElement(
                ...
                var trClasses = (0, _classnames2.default)({
                  'data-table-row': true
                });
                var ret = _react2.default.createElement(
                  'tr',
                  { key: i, className: trClasses, style: { height: rowProps.height } },
                  tds
                );
                return ret;
              })
            ),
            isPaging && this.state.totalPage > 1 && _react2.default.createElement(
              'tfoot',
              null,
              _react2.default.createElement(
                'tr',
                ...
                _react2.default.createElement(
                  ...
                  _react2.default.createElement(
                    ...
                    this.state.page > 1 && _react2.default.createElement(
                      'a',
                      { 'class': 'icon item', onClick: this.previousPage.bind(this) },
                      _react2.default.createElement('i', { 'class': 'left chevron icon' })
                    ),
                    _lodash2.default.times(this.state.totalPage, function (i) {
                      var page = i + 1;
                      var itemClass = (0, _classnames2.default)({
                        'item': true,
                        'active': _this2.state.page == page
                      });
                      return _react2.default.createElement(
                        'a',
                        { className: itemClass, onClick: _this2.gotoPage.bind(_this2) },
                        page
                      );
                    }, this),
                    this.state.page < this.state.totalPage && _react2.default.createElement(
                      'a',
                      { 'class': 'icon item', onClick: this.nextPage.bind(this) },
                      _react2.default.createElement('i', { 'class': 'right chevron icon' })
                    )
                  )
                )
              )
...
DataTable.propTypes = {
  ...
  row: _propTypes2.default.shape({
    height: _propTypes2.default.number.optional
  }).optional,
  columns: _propTypes2.default.arrayOf(_propTypes2.default.shape({
    name: _propTypes2.default.string.isRequired,
    label: _propTypes2.default.string.isRequired,
    headerAlign: _propTypes2.default.oneOf(['left', 'center', 'right']).optional,
    accessor: _propTypes2.default.string.isRequired,
    cell: _propTypes2.default.func.optional,
    width: _propTypes2.default.string.optional,
    align: _propTypes2.default.oneOf(['left', 'center', 'right']).optional,
    isSorted: _propTypes2.default.bool.optional,
    isFrozen: _propTypes2.default.bool.optional
  })).isRequired,
  data: _propTypes2.default.array,
  isPaging: _propTypes2.default.bool.isRequired,
  width: _propTypes2.default.string.optional,
  height: _propTypes2.default.string.optional,
  columnWidthType: _propTypes2.default.oneOf(['px', 'em', 'rem', '%']).optional,
  fontSize: _propTypes2.default.string.optional,
  tableLayout: _propTypes2.default.string.optional
};
