...
var FilterForm = function (_React$Component) {
  ...
  function FilterForm(props) {
    ...
    _this.filterTable = props.filterTable;

    _this.createFilterInput = _this.createFilterInput.bind(_this);
    return _this;
  }
  ...
  _createClass(FilterForm, [{
    ...
    value: function createFilterInput(filter) {
      var _this2 = this;

      var data = this.state.data[filter.name];
    ...
    value: function render() {
      ...
      var expandIcon = (0, _classnames2.default)({
        'icon': true,
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'div',
          { className: 'ui segment secondary filterSegment', onClick: this.filterParaClicked.bind(this) },
          _react2.default.createElement(
            'p',
            null,
            'Filter',
            _react2.default.createElement(
              'a',
              { href: 'javascript:;' },
              _react2.default.createElement('i', { className: expandIcon })
            )
          )
        ),
        this.state.isShowFilter && _react2.default.createElement(
          'div',
          { 'class': 'ui segment' },
          _react2.default.createElement(
            'form',
            { className: 'ui form' },
            _lodash2.default.times(rowSize, function (i) {

              var columnSize = [];
              _lodash2.default.forEach(filters, function (filter, key) {
                if (filter.row === i + 1) {
                  columnSize.push(key);
                }
              });
              ...
              var fields = _lodash2.default.times(columnSize.length, function (j) {
                var filter = filters[columnSize[j]];
                return _this3.createFilterInput(filter);
              });
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                ...
                _react2.default.createElement(
                  'a',
                  { className: 'ui blue button searchButton', onClick: this.submitClicked.bind(this) },
                  _react2.default.createElement('i', { 'class': 'search icon' }),
                  'Search'
                ),
                _react2.default.createElement(
                  'a',
                  { className: 'ui button', onClick: this.clearClicked.bind(this) },
                  _react2.default.createElement('i', { 'class': 'refresh icon' }),
                  'Clear'
                )
              ),
...
FilterForm.propTypes = {
  filterTable: _propTypes2.default.func.isRequired,
  filters: _propTypes2.default.arrayOf(_propTypes2.default.shape({
    name: _propTypes2.default.string.isRequired,
    param: _propTypes2.default.string.isRequired,
    label: _propTypes2.default.string.isRequired,
    type: _propTypes2.default.string.isRequired,
    row: _propTypes2.default.number.optional,
    columnWidth: _propTypes2.default.number.optional,
    options: _propTypes2.default.array.optional,
    optionValueField: _propTypes2.default.string.optional,
    optionLabelField: _propTypes2.default.string.optional
  })).isRequired,
  data: _propTypes2.default.array,
  components: _propTypes2.default.array.optional
};
